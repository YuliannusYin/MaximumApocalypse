#ScavengeCardManager.gd
extends Node2D

const COLLISION_MASK_CARD = 64          # 拾荒卡牌碰撞层（对应 InputManager.COLLISION_MASK_SCAVENGE_CARD）
const COLLISION_MASK_CARD_SLOT = 2      # 卡牌槽位碰撞层（与 SurvivorCardSlot 共用）
...
func _ready() -> void:
	...
	player_hand_referened = $"../PlayerHand"
