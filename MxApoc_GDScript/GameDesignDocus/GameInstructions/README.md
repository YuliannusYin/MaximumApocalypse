...
| B | [B_missionObjectives.md](B_missionObjectives.md) | 任务目标 | 任务剧本与目标说明 |
| C | [C_gameSetup.md](C_gameSetup.md) | 开始游戏 | 游戏房间设置、初始化、开局流程 |
| D | [D_gameFlow.md](D_gameFlow.md) | 游戏流程 | 玩家回合的完整阶段流程 |
...
|------|------|
| [D_gameFlow.md](D_gameFlow.md) 玩家回合流程 | [Player.md](../GameSystem/Entities/Player.md) 各阶段方法 |
...
- [B_missionObjectives.md](B_missionObjectives.md) — 任务目标详细说明
- [H_useCard.md](H_useCard.md) — 卡牌使用完整规则
