...
# [新增] 2026-06-28: 卡牌显示名称
var card_name: String

# [新增] 2026-06-24: 装备牌的当前弹药/耐久
var current_ammo: int = 0

# [新增] 2026-06-29: 怪物卡的当前生命值
var current_hp: int = 0

# [新增] 2026-06-24: 初始化卡牌运行时实例
func _init(_instance_id: String, _template_id: String, _card_name: String = "", _ammo: int = 0, _hp: int = 0):
	self.instance_id = _instance_id
	self.template_id = _template_id
	self.card_name = _card_name if _card_name != "" else _template_id
